...
class Roku(object):
    ...
    def _call(self, method, path, *args, **kwargs):
        ...
        # resp = func(url, *args, **kwargs)
            ...
            raise RokuException(e.read())

        raise RokuException(None)

    @property
    def apps(self):
        resp = self._get('/query/apps')
        applications = self.deserialize_apps(resp)
    ...
    def deserialize_apps(self, doc, roku=None):
